...
const Experience = () => {
  const experiences = [{
    ...
    achievements: ["Built intelligent chatbots with natural language processing", "Implemented ML algorithms including Cosine Similarity", "Developed Minimax algorithm for decision-making systems", "Created Python-based automation solutions"],
    ...
    achievements: ["Developed Titanic survival prediction classifier", "Created interactive dashboards using Power BI", "Implemented statistical tests for model validation", "Enhanced model performance through feature engineering", "Analyzed large datasets for actionable insights"],
  ...
  return <section id="experience" className="py-20 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="space-y-8">
          {experiences.map((exp, index) => <Card key={index} className={`bg-gradient-to-br ${exp.bgGradient} ${exp.borderColor} hover:border-opacity-60 transition-all duration-300 hover:scale-[1.02]`}>
                ...
                <div className="grid lg:grid-cols-3 gap-8">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h3 className="text-2xl font-bold text-sky-400">{exp.company}</h3>
                  ...
                  <div className="lg:col-span-2 space-y-6">
                    ...
                    <div className="grid gap-3">
                      {exp.achievements.map((achievement, achievementIndex) => <div key={achievementIndex} className="flex items-start gap-3 p-3 rounded-lg bg-slate-800/30 hover:bg-slate-800/50 transition-colors duration-200">
