      ...
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="text-center lg:text-left space-y-8 animate-fade-in">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
            ...
            <Button variant="outline" className="border-cyan-500/50 text-cyan-400 hover:bg-cyan-500/10 px-8 py-6 text-lg rounded-xl" onClick={() => scrollToSection("projects")}>
              <Eye className="w-5 h-5 mr-2" />
              View Projects
            </Button>
            
            <Button variant="outline" className="border-purple-500/50 text-purple-400 hover:bg-purple-500/10 px-8 py-6 text-lg rounded-xl" onClick={() => scrollToSection("contact")}>
          ...
          <div className="relative">
            <div className="w-80 h-80 md:w-96 md:h-96 rounded-full bg-gradient-to-br from-cyan-400 via-purple-500 to-pink-500 p-1 animate-pulse">
              <div className="w-full h-full rounded-full bg-slate-900 flex items-center justify-center overflow-hidden">
                <img src="https://i.postimg.cc/2jQjLz7G/PHOTU.png" alt="Tanya Tomar - Data Science Professional" className="w-full h-full object-cover rounded-full" />
              </div>
            </div>
